...
document.addEventListener('DOMContentLoaded', function() {
  var editLinks = document.querySelectorAll('.dropdown-item');

  editLinks.forEach(function(editLink) {
    editLink.addEventListener('click', function(event) {
      event.preventDefault();

      // استدعاء الدالة لاسترداد قيمة id
      var id = getLinkId(this);

      // إجراءات تستخدم القيمة المسترجعة id
      console.log('تم النقر على العنصر. قيمة الـ id: ' + id);
      // قم بإضافة الإجراءات الأخرى هنا

    });
  });

  function getLinkId(element) {
    // استرداد قيمة الـ id من العنصر المحدد
    var id = element.dataset.id;

    // إرجاع القيمة للاستخدام في الدالة الأعلى
    return id;
  }
});
  </script>
										...
										<tr>
                                            ...
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="#" data-toggle="modal" data-id="454" data-target="#edit_department"><i class="fa fa-pencil m-r-5"></i> Edit</a>
						...
						<div class="modal-content">
							...
							<div class="modal-body">
								...
								<form action="{{route('categories.edit',)}}" method="POST">
                                    ...
                                    <input type="hidden" name="edit-id" id="edit-id-input" value="">
