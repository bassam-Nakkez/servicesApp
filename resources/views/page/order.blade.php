											...
											<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
												<div class="card">
													<div class="card-body">
														...
														<h4 class="project-title"><a href="">Home Cleanning</a></h4>
														<small class="block text-ellipsis m-b-15">
															<span class="text-xs">Date</span> <span class="text-muted">Tuesday 19th june 2023  </span>

														</small>
														<p class="text-muted">Surfaces and floors, sanitary facilities window
															cleaning,egarbage cans,maintenance of household appliances,washinf up...
															...
															<div class="activity-user">
																<td class="text-right">
																	<h2 class="table-avatar">
																		...
																		<a href="profile.html"><span class="small-name">Abd alkhateb</span></a> <!-- Add this line -->
																	</h2>
																</td>
															</div>
														</div>
											...
											<div class="col-lg-4 col-sm-6 col-md-4 col-xl-3">
												<div class="card">
													<div class="card-body">
														...
														<h4 class="project-title"><a href="project-view.html">Home Cleanning</a></h4>
														<small class="block text-ellipsis m-b-15">
															<span class="text-xs">Date</span> <span class="text-muted">Tuesday 19th june 2023  </span>
